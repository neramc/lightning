...
3. **The capability system is sacred.** Every action MUST declare per-platform support plus a runtime probe where relevant (§6.6, §8.1). The frontend renders capability *data* from the engine — never hardcode per-OS UI hacks in React.
